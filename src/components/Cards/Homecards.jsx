...
function Homecards({ img, title, buttontext, link }) {
  ...
  return (
    <div id="HomeCard" className=' border-black bg-white rounded-md relative  hover:-translate-y-5 bg  !duration-1000 h-[250px]  group  mx-auto     w-full  drop-shadow-2xl  overflow-hidden  p-5 flex justify-center items-center'>
        ...
        <div className=' relative mb-5  !duration-200 flex flex-col justify-center items-center'>
          ...
          <img className='w-[40px] animate-image-pop-up !duration-1000  h-[40px] lg:w-[100px] lg:h-[100px]  md:w-[70px] md:h-[70px]' src={img} alt='Cart' />
              ...
              <button className=' border-t-[1px] border-black flex h-[50px] home_button  w-full  text-white items-center justify-center   absolute bottom-0 right-0 left-0' >
