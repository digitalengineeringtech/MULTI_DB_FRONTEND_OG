        ...
        if (selectedStation.code === "Please") {
          ...
          const fetchData = async () => {
            ...
            // await dispatch(fetchDynamicNozzles(bomb));
             fetchIt(`/detail-sale/by-date/?sDate=${startDate}&eDate=${endDate}&stationDetailId=${selectedStation.code}&accessDb=${user.accessDb}`, user.token);

            fetchIt_2(`/detail-sale/statement-report?sDate=${startDate}&eDate=${endDate}&stationDetailId=${selectedStation.code}&accessDb=${user.accessDb}`,user.token);
