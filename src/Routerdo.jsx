    ...
    <>
     {(() => {
      ...
      <Routes>
        ...
        <Route path={`/${user.accessDb}/dailysalereport`} element={<DailySaleReportOne/>}></Route>
        <Route path={`/${user.accessDb}/fueldatareport`} element={<FuelInDailyReport />}></Route>
        <Route path={`/${user.accessDb}/dailysalesummaryreport`} element={<DailyThisDay />}></Route>
        <Route path='/kyawsan/searchreports' element={<SearchReports />}></Route>   
        <Route path={`/${user.accessDb}/tankbalancereport`} element={<TankBalanceReport />}></Route>    
        <Route path={`/${user.accessDb}/salessummarbystation`} element={<DailySummaryByStationReport/>}></Route>    
        <Route path={`/${user.accessDb}/statementreport`} element={<StatementReport/>}></Route>    
        <Route path={`/${user.accessDb}/onlinemonitoringsalereport`} element={<OnlineMonitoringSaleReport/>}></Route>
        <Route path={`/${user.accessDb}/categoriesreport`} element={<DailySaleCategoriesReport1 />}></Route>
        <Route path={`/${user.accessDb}/weekly`} element={<WeeklySaleReport />}></Route>
        <Route path={`/${user.accessDb}/fuelbalance`} element={<FuelBalanceReport/>}></Route>
        <Route path='/kyawsan/adjustment' element={<Adjustment />}></Route>
        <Route path={`/${user.accessDb}/tankdemo`} element={<TankBalance/>}></Route>
        <Route path={`/${user.accessDb}/fueltypebalance`} element={<FuelTypeBalanceReport />}></Route>    
        <Route path={`/${user.accessDb}/real-tank`} element={<RealTimeTank />}></Route>    
        <Route path='/usermanual' element={<UserManual />} />
        {/* kyawsan amdin */}
        <Route path={`/${user.accessDb}/main-con/dash`} element={<MainConDas />} />
