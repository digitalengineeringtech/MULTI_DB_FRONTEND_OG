...
function StationDetailTable({ station, isSetUp,data,handleEdit,setIsSure,setStationName,stationLiense,setStationLiense,stationLocation,setStationLocation,stationDeviceCount,setStationDeviceCount,stationNozzleCount,setStationNozzleCount,stationName,stationLoading,deleteStation }) {
    ...
    const handleAdd = (e, keye) => {
        ...
        instance.patch(`/station-detail/permission?accessDb=${name}`, { _id: e._id, keye: keye }, {
        headers:{
...
value={stationLiense}
                    ...
                    <td className='bg-blue-300'>
                        <ul className='bg-blue-300 relative font-bold h-full flex items-center justify-center w-full group'>Hover <MdArrowDropDown/>
                        <ul className='absolute hidden z-40 p-2 top-[90%] group-hover:block border-[0.5px]  bg-gray-100  w-[240px]'>
                            <StationPermits handleAdd={handleAdd} handleDelete={handleAdd} e={e} keye={'user'} />
                            <StationPermits handleAdd={handleAdd} handleDelete={handleAdd} e={e} keye={'manager'} />
                            <StationPermits handleAdd={handleAdd} handleDelete={handleAdd} e={e} keye={'pprd'} />
                        </ul>
                        </ul>
                    </td>
