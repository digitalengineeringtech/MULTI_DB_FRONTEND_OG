...
function Instructions() {
  ...
  const listyle =
    "h-[70px] hover:scale-[1.02] duration-300 rounded-md mb-2 flex items-center justify-around bg-white px-5";

  return (
    <div className="w-[100%]  hover:-translate-y-1 hover:scale-[1.01] duration-300 bg-white rounded-lg drop-shadow-2xl h-[400px]">
      <div className=" rounded-t-2xl  bg-gray-100 h-[50px] flex justify-start items-center px-[30px] font-semibold">
        <p>Records</p>
      </div>
              ...
              <li className={listyle} key={date}>
                ...
                <p className="w-[33.33%]">
                  ...
                  <span className=" text-lg font-extrabold">
                    {" "}
                    {okData[date].totalLiter?.toFixed(3)}
                  </span>
                </p>
                <p className="w-[33.33%]">
                  Total Price :{" "}
