...
// eslint-disable-next-line no-unused-vars
 ...
 const user = useSelector((state) => state.login);
  ...
  getIt_1(`/detail-sale/perday/categories/total?sDate=${startDate}&eDate=${endDate}&vehicleType=Cycle,Car,Trailer ( High way ),Trailer ( City ),Htawlargyi,Cycle ( 3 Wheels )&accessDb=${user.accessDb}`, user.token);
